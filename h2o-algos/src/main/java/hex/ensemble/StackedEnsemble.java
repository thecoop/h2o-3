...
public class StackedEnsemble extends ModelBuilder<StackedEnsembleModel,StackedEnsembleModel.StackedEnsembleParameters,StackedEnsembleModel.StackedEnsembleOutput> {
  ...
  /**
   * Add miscellaneous columns to levelOneFrame, i.e., all but those generated by base models. For example:
   ...
   */
  static void addMiscColumnsToLevelOneFrame(final StackedEnsembleModel.StackedEnsembleParameters parms, Frame fr, Frame levelOneFrame, boolean training) {
    if (training) {
